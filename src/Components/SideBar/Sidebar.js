...
import "/media/hp/107 GB Volume1/WebDev/Projects/taskio/src/Components/SideBar/Sidebar.css";
import Taskio from "/media/hp/107 GB Volume1/WebDev/Projects/taskio/src/Assests/Taskio.png";
import DueDateSelector from "/media/hp/107 GB Volume1/WebDev/Projects/taskio/src/Components/DueDateSelector/DueDateSelector.js"; // Adjust the import path as per your project structure
...
import AttachmentsForm from "/media/hp/107 GB Volume1/WebDev/Projects/taskio/src/Components/AttachmentsForm/AttachmentsForm.js";
...
const Sidebar = () => {
  ...
  const handleDueDateSet = (dueDate) => {
    // Logic to handle the due date
    console.log(`Due Date: ${dueDate}`);
  };
  
  
  const handleReminderAdd = (reminder) => {
    // Logic to add the reminder to your task manager
  ...
  useEffect(() => {
    ...
    messagesBtn.addEventListener("click", handleMessagesBtnClick);
    document
    ...
    return () => {
      ...
      messagesBtn.removeEventListener("click", handleMessagesBtnClick);
      document
        .querySelector(".messages-close")
    ...
    <div className="app-container">
      <div className="app-header">
        <div className="app-header-left">
          <img className="dash-logo" src={Taskio} alt="" width={32} />
          <p className="app-name">Taskio</p>
        ...
        <div className="app-header-right">
          ...
          {/* Create new task - Popup Component  */}
          <div
              ...
              <div className="modal-content">
                ...
                <div className="modal-body">
                  <form>
                    ...
                    <DueDateSelector onDueDateSet={handleDueDateSet} />
                    <TaskPrioritySelector />

                    <TaskReminder onReminderAdd={handleReminderAdd} />
          ...
          <div className="project-boxes jsGridView">
            <div className="project-box-wrapper">
              ...
              >
                <div className="project-box-header">
                  ...
                  <div className="more-wrapper dropdown">
                    <button
                      className="project-btn-more dropdown"
                ...
                <div className="project-box-footer">
                  <div className="edit-task" style={{ color: "#ff942e" }}>
                    Edit Task
                  </div>
            ...
            <div className="project-box-wrapper">
              ...
              >
                ...
                <div className="project-box-footer">
                  <div className="edit-task" style={{ color: "#4f3ff0" }}>
                    Edit Task
                  </div>
            ...
            <div className="project-box-wrapper">
              <div className="project-box">
                ...
                <div className="project-box-footer">
                  <div className="edit-task" style={{ color: "#096c86" }}>
                    Edit Task
                  </div>
            ...
            <div className="project-box-wrapper">
              ...
              >
                ...
                <div className="project-box-footer">
                  <div className="edit-task" style={{ color: "#df3670" }}>
                    Edit Task
                  </div>
            ...
            <div className="project-box-wrapper">
              ...
              >
                ...
                <div className="project-box-footer">
                  <div className="edit-task" style={{ color: "#34c471" }}>
                    Edit Task
                  </div>
            ...
            <div className="project-box-wrapper">
              ...
              >
                ...
                <div className="project-box-footer">
                  <div className="edit-task" style={{ color: "#4067f9" }}>
                    Edit Task
                  </div>
